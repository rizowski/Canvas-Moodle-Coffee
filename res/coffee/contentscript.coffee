...
$(document).ready ->
  ...
  # class Query
  #   course_url : "/api/v1/courses?include[]=total_scores&state[]=available"
  #   canvas_courses_url : "/courses/"
  #   assignment_url : (_courseId) ->
  ...
  #   add_divs : () -> 
  #     # $("aside#right-side").prepend "<div id='notice-container' style='display: none;'>
